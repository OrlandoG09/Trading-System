...
def run_full_cycle():
    ...
    # =========================================================
    # FASE 1: ETL & PROCESAMIENTO (TUS SCRIPTS)
    # =========================================================
    
    # 1. BAJAR PRECIOS (Actualiza hasta hoy)
    ...
    # 4. CALCULAR SENTIMIENTO (FinBERT) <-- PASO CRÍTICO QUE FALTABA
